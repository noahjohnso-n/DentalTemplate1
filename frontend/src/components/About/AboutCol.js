...
export default function AboutSplit(){
    ...
    return (
        <section>
            <div className="about-landing-col">
                <p className="abt-title-col">We want you to look forward to the dentist.</p>
            ...
            <Divider />
            <div className="head-doc-div">
                <img className="head-doc-col" src = "/head-doc.jpg" alt = "Head doctor"/>
                <p className= "abt-person">Dr. Jane Doe</p>
                <p className="abt-job">General Dentist</p>
            ...
            <div className="visit-today">
                <div id = "visit-head" className="visit-row">
                    <p className="visit-title-col">Visit us today!</p>
                </div>
                <div className="visit-row">
                    <i className="bi bi-geo-alt-fill"></i><p className="visit-text-col">123 Dentist Rd. Columbus, OH 43004</p>
                </div>
                <div className="visit-row">
                    <i className="bi bi-clock-fill"></i>
                    <div className="hour-col">
                        <p className="visit-text-col">Monday - Thursday: 9 - 7 </p>
                        <p className="visit-text-col">Friday & Saturday: 9 - 5 </p>
                    </div>
                </div>
                <div className="visit-row">
                    <i class="bi bi-telephone-fill"></i><p className="visit-text-col">(330) 323 - XXXX</p>
                </div>
                <div className="visit-row">
                    <i class="bi bi-envelope-fill"></i><p className="visit-text-col">dentist@email.com</p>
                </div>
            </div>
        </section>
    )
