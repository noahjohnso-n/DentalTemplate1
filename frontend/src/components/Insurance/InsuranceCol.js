...
export default function InsuranceCol() {
    ...
    return (
        <>
            <h1 className="i-title">Insurance</h1>
            ...
            <div className="i-container">
                {isVisible && <div className="i-box">
                    <p className="i-box-title">See if your exam is covered</p>
                    <p className="i-box-text">Curious if your insurance covers you for a React exam? We can tell you in just a few seconds.</p>
                ...
                {!isVisible && <div className="i-response">
                    ...
                    {hasInsurance && <div className="i-good">
                        ...
                        <p className="i-good-text-plain">*We’re in-network with most plans offered by your insurer, but don’t accept HMO, DMO, or Medicare plans. If we don’t accept your plan, we’ll be in touch before your visit.</p>
                        <Link className="no-i-a" to = "/book">
                            <button className="no-insurance-book">BOOK NOW</button>
                        </Link>
                    </div>}
